...
def interval_logs():
    ...
    # find /base/data/svc_core_np/*  maxdepth 0 -type d -ctime +30 -ctime -60
    temp_result2 = subprocess.run('find /base/logs/* -type d,f,l -mtime -100',shell=True,stdout=subprocess.PIPE)
